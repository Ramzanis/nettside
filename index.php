                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <a href="index.html" class="logo">
                            <h4>SMMA <img src="assets/images/logo-icon.png" alt=""></h4>
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="#about">Om Oss</a></li>
                            <li class="scroll-to-section"><a href="#services">Tjenester</a></li>
                            <!-- <li class="scroll-to-section"><a href="#portfolio">Portfolio</a></li> -->
                            <li class="scroll-to-section">
                                <div class="main-blue-button"><a href="#contact">Book Møte</a></div>
                            </li>
                        </ul>
                        ...
                        <div class="col-lg-6 align-self-center">
                            <div class="left-content header-text wow fadeInLeft" data-wow-duration="1s"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <h2>Fra visjon til virkelighet</h2>
                                    </div>
                                    <div class="col-lg-12">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 align-self-center wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                    <div class="section-heading">
                        <h6>Om Oss</h6>
                        <h2>Innovative <em>løsninger</em> for digital suksess.</h2>
                    </div>
                    <!-- <div class="row">
            <div class="col-lg-4 col-sm-4">
              ...
              <div class="about-item">
                ...
                <h6>awards</h6>
                    ...
                    <p>Vi er et team av dyktige profesjonelle innen bl. a. webdesign, programvareutvikling, digital
                        ...
                        teknologiene for å hjelpe våre kunder med å få mest mulig ut av sine digitale investeringer.</p>
                    <div class="main-green-button"><a href="#contact">Kontakt Oss</a></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading wow bounceIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        <h6>Våre tjenester</h6>
                        <h2>Oppdag <span>Tjenester</span> Vi Tilbyr Til Våre <em>Kunder</em></h2>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <div class="right-content">
                                    ...
                                    <p>Vi kan Utvikle reponsive og funksjonelle nettsider basert på dine krav. Vi </p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="features-item first-feature wow fadeInUp" data-wow-duration="1s"
                                    ...
                                    <p>Første steg i prosessen innebærer at kunden uttrykker sine
                                        behov. Dette gir oss muligheten til å forstå kundens mål og
                                        finne ut hvordan tjenestene våre best kan møte disse behovene.</p>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="features-item second-feature wow fadeInUp" data-wow-duration="1s"
                                    ...
                                    <div class="icon"></div>
                                    <h4>Utvikle Strategi</h4>
                                    <div class="line-dec"></div>
                                    <p>Basert på informasjonen vi har samlet inn fra kunden, utvikler vi en strategi
                                        tilpasset kundens mål og spesifikke krav.</p>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="features-item first-feature wow fadeInUp" data-wow-duration="1s"
                                    ...
                                    <div class="icon"></div>
                                    <h4>Produkt Design</h4>
                                    <div class="line-dec"></div>
                                    <p>Når strategien er godkjent, begynner vi å designe produktet. Dette innebærer å
                                        lage en prototype og teste den for å sikre at den oppfyller kundens
                                        spesifikasjoner.</p>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="features-item second-feature last-features-item wow fadeInUp"
                                    ...
                                    <div class="icon"></div>
                                    <h4>Implementasjon</h4>
                                    <div class="line-dec"></div>
                                    <p>Vi går deretter videre med implementeringen av produktet. Dette inkluderer å
                                        integrere produktet i kundens eksisterende systemer og sikre at det fungerer
                                        korrekt.</p>
                                </div>
                            </div>
                        </div>
